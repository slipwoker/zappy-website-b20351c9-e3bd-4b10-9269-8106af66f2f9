document.addEventListener('DOMContentLoaded', function () {
  ...
  function showFieldError(field, message) {
    ...
    field.addEventListener('input', function onInput() {
      ...
      const existingError = parent ? parent.querySelector('.form-error-message') : null;
    ...
    mutations.forEach(function (mutation) {
      mutation.addedNodes.forEach(function (node) {
        ...
        if (node.matches && node.matches(OBSERVED_SELECTOR)) {
          initElementAnimation(node);
        }

        const children = node.querySelectorAll ? node.querySelectorAll(OBSERVED_SELECTOR) : [];
        children.forEach(function (child) {
          initElementAnimation(child);
        });
      });
    });
  });

  function initElementAnimation(el) {
    if (el.classList.contains(ANIMATION_CLASS)) return;
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "צמרת פיננסים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'b20351c9-e3bd-4b10-9269-8106af66f2f9',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'b20351c9-e3bd-4b10-9269-8106af66f2f9';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'b20351c9-e3bd-4b10-9269-8106af66f2f9';
